---
name: d2-activity
description: Tạo sơ đồ luồng quy trình nghiệp vụ bằng ngôn ngữ D2, tự động render ra ảnh PNG qua render.sh chung.
---
...
Kích hoạt bằng câu lệnh tự nhiên hoặc cú pháp lệnh: `/d2-activity`
