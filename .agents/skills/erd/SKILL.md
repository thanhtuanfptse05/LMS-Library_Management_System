---
name: erd
description: Tạo sơ đồ ERD Mermaid từ cấu trúc thực thể dữ liệu, kiểm tra cú pháp qua mmdc và tự xem ảnh review.
---
...
Kích hoạt bằng câu lệnh tự nhiên hoặc cú pháp lệnh: `/erd`
