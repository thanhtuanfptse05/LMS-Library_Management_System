---
name: dbdiagram
description: Tạo mã DBML cho sơ đồ cơ sở dữ liệu từ thiết kế hệ thống, biên dịch tự động ra SQL DDL qua dbml2sql.
---
...
Kích hoạt bằng câu lệnh tự nhiên hoặc cú pháp lệnh: `/dbdiagram`
