...
description: Tạo activity diagram phân làn (swimlane) bằng PlantUML từ quy trình nghiệp vụ BA, hiển thị rõ trách nhiệm từng actor/lane, xuất ảnh PNG qua render.sh.
---

Base directory for this skill: /Volumes/Data/AI4BAv2/english-ai-demo/.agents/skills/activity-swimlane

# /activity-swimlane — Activity Diagram với Swimlane thật (PlantUML)

## Cách gọi

Kích hoạt bằng câu lệnh tự nhiên hoặc cú pháp lệnh: `/activity-swimlane`
