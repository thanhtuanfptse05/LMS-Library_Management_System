 ...
 *
 * Dùng:
 *   node .agents/skills/_shared/mermaid-verify.mjs --file docs/{feature}/srs/flows.md
 *   node .agents/skills/_shared/mermaid-verify.mjs --file docs/x/srs/x-erd.md --png /tmp/erd-review
 *
