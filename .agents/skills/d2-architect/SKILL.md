---
name: d2-architect
description: Tạo sơ đồ kiến trúc hệ thống, block diagram, diagram thành phần bằng ngôn ngữ D2, render ra PNG qua render.sh.
---
...
Kích hoạt bằng câu lệnh tự nhiên hoặc cú pháp lệnh: `/d2-architect`
