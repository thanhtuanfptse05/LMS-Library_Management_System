---
name: bpmn
description: Tạo sơ đồ BPMN 2.0 chuẩn nghiệp vụ từ quy trình BA, kiểm tra ngữ nghĩa và tự động bố cục qua bpmn engine chung, xuất ra .bpmn và trình xem HTML.
---
...
Kích hoạt bằng câu lệnh tự nhiên hoặc cú pháp lệnh: `/bpmn`
