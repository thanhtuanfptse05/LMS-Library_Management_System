...
description: Tạo sơ đồ Use Case bằng PlantUML từ danh sách tác nhân và ca sử dụng nghiệp vụ, render ra ảnh PNG.
---
...
Kích hoạt bằng câu lệnh tự nhiên hoặc cú pháp lệnh: `/usecase-diagram`
...
- **Per .agents/rules/diagram-selection.md** — nếu feature chỉ 1 actor + 1 use case → warn "overkill, có thể skip".
