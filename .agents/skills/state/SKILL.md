---
name: state
description: Tạo sơ đồ chuyển trạng thái (State Diagram) Mermaid cho các thực thể có vòng đời phức tạp, kiểm tra cú pháp qua mmdc.
---
...
Kích hoạt bằng câu lệnh tự nhiên hoặc cú pháp lệnh: `/state`
...
- **Per .agents/rules/diagram-selection.md** — entity ≥3 states trước proceed; <3 → warn "bảng đủ, có cần diagram?".
