...
-- - Lê Thế Bảo (B): adminB1@lms.com, librarianB1@lms.com, lecturerB1@lms.com, studentB1@lms.com
-- - Nguyễn Văn Chương (C): adminC1@lms.com, librarianC1@lms.com, lecturerC1@lms.com, studentC1@lms.com
-- - Cao Thanh Tuấn (T): adminT1@lms.com, librarianT1@lms.com, lecturerT1@lms.com, studentT1@lms.com
-- - Nguyễn Việt Thái (V): adminV1@lms.com, librarianV1@lms.com, lecturerV1@lms.com, studentV1@lms.com
-- - Vũ Đức Quyết (Q): adminQ1@lms.com, librarianQ1@lms.com, lecturerQ1@lms.com, studentQ1@lms.com
...
BEGIN
    ...
    VALUES (v_uid, 'Lê Thế Bảo', '0962969970', 'Nam', '2000-01-01');
    ...
    INSERT INTO MemberProfile (userId, fullName, phoneNumber, gender, dateOfBirth)
    VALUES (v_uid, 'Lê Thế Bảo', '0962969970', 'Nam', '2000-01-01');
    INSERT INTO Student (userId, studentCode, major, enrollmentYear) VALUES (v_uid, 'HE180001', 'Computer Science', 2022);


    -- =========================================================================
    -- 2. NGUYỄN VĂN CHƯƠNG (Mã định danh: C)
    -- =========================================================================
    ...
    RETURNING userId INTO v_uid;
    INSERT INTO MemberProfile (userId, fullName, phoneNumber, gender, dateOfBirth)
    VALUES (v_uid, 'Nguyễn Văn Chương', '0987654321', 'Nam', '2000-02-02');
    ...
    -- =========================================================================
    -- 3. CAO THANH TUẤN (Mã định danh: T)
    -- =========================================================================
    ...
    RETURNING userId INTO v_uid;
    INSERT INTO MemberProfile (userId, fullName, phoneNumber, gender, dateOfBirth)
    VALUES (v_uid, 'Cao Thanh Tuấn', '0123456789', 'Nam', '2005-12-01');
    ...
    INSERT INTO MemberProfile (userId, fullName, phoneNumber, gender, dateOfBirth)
    VALUES (v_uid, 'Cao Thanh Tuấn', '0123456789', 'Nam', '2005-12-01');
    INSERT INTO Student (userId, studentCode, major, enrollmentYear) VALUES (v_uid, 'HE180003', 'Software Engineering', 2022);


    -- =========================================================================
    -- 4. NGUYỄN VIỆT THÁI (Mã định danh: V)
    -- =========================================================================
    ...
    RETURNING userId INTO v_uid;
    INSERT INTO MemberProfile (userId, fullName, phoneNumber, gender, dateOfBirth)
    VALUES (v_uid, 'Nguyễn Việt Thái', '0912345678', 'Nam', '2000-04-04');
    ...
    INSERT INTO MemberProfile (userId, fullName, phoneNumber, gender, dateOfBirth)
    VALUES (v_uid, 'Nguyễn Việt Thái', '0912345678', 'Nam', '2000-04-04');
    INSERT INTO Student (userId, studentCode, major, enrollmentYear) VALUES (v_uid, 'HE180004', 'Hospitality Management', 2022);


    -- =========================================================================
    -- 5. VŨ ĐỨC QUYẾT (Mã định danh: Q)
    -- =========================================================================
    ...
    RETURNING userId INTO v_uid;
    INSERT INTO MemberProfile (userId, fullName, phoneNumber, gender, dateOfBirth)
    VALUES (v_uid, 'Vũ Đức Quyết', '0934567890', 'Nam', '2000-05-05');
