-- ============================================================
-- LMS SEED DATA — BẢNG DocumentTemp (Mẫu Email Hệ Thống)
-- Version: 1.0.0 | Tạo: 2026-06-25
-- ============================================================
-- Lưu ý quan trọng:
--   - Bảng này hoạt động như một bảng cấu hình hệ thống (System Config).
--   - 6 mẫu dưới đây là CỐT LÕI, được seed khi deploy lần đầu.
--   - Manager được phép chỉnh sửa subject và bodyContent.
--   - KHÔNG ĐƯỢC PHÉP XÓA các mẫu có tempName trong danh sách hệ thống.
--   - managerId = 6 là ID của Library Manager mặc định trong hệ thống.
-- ============================================================


INSERT INTO DocumentTemp (tempName, description, subject, bodyContent, managerId, createdAt)
VALUES
