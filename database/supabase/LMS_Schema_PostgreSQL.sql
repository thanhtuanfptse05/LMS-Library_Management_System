...
CREATE TABLE IF NOT EXISTS UserLockReason (
...
CREATE TABLE IF NOT EXISTS LibraryManager (
    userId INT PRIMARY KEY,
    staffCode VARCHAR(50) NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS DocumentTemp (
...
CREATE TABLE IF NOT EXISTS BookCopyIncident (
...
CREATE TABLE IF NOT EXISTS BookImportBatch (
...
CREATE TABLE IF NOT EXISTS BookImportError (
