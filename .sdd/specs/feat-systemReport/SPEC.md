...
### Mapping Boundary
* Canonical source: diagram/spec-UC-BR-FR.md cho F11 System Reports, F16 Dashboard — Manager. Các UC ngoài danh sách trên thuộc feature khác và không được map vào feature này.
