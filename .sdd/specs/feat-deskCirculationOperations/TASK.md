...
| **T-F6-03** | Service Layer (Check-in Logic) | `DeskCirculationService.java` | 3h | T-F6-01 | Phân nhánh Condition: (1) Sách hỏng/mất: ngừng lưu thông, tạo incident `pending` theo F13, ghi phạt/khóa nếu có, không luân chuyển hàng chờ. (2) Sách tốt: check next queue, allocate/return to inventory. |
