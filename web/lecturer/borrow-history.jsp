        ...
        <div class="container-xl px-4 py-5">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb" style="font-size: 14px;">
                    <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/lecturer/dashboard" class="text-decoration-none" style="color: var(--primary);">Bảng điều khiển</a></li>
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4">
                <div>
                    ...
                    <p class="mb-0" style="color: var(--on-surface-variant);">Xem lại toàn bộ thông tin và trạng thái các cuốn sách thầy/cô đã và đang mượn tại thư viện.</p>
                </div>
            </div>
                    ...
                    <c:choose>
                        <c:when test="${empty history}">
                            ...
                            <div class="text-center py-5">
                                ...
                                <p style="color: var(--on-surface-variant); font-size: 14px;" class="mb-4">Thầy/cô chưa mượn cuốn sách nào từ hệ thống thư viện.</p>
