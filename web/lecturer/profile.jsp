    ...
    <div class="d-flex main-wrapper overflow-hidden">
        ...
        <main class="flex-grow-1 overflow-y-auto" style="background-color: #f7f9fb; margin-left: 256px;">
            ...
            <div class="container-fluid px-4 py-4" style="max-width: 1400px; margin: 0 auto;">
                ...
                <div class="mb-4">
                    <h2 class="font-headline-lg mb-1" style="color: var(--on-surface);">Lecturer Profile</h2>
                    <p class="font-body-md text-on-surface-variant">Manage your faculty library credentials and academic information.</p>
                </div>
                        ...
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div class="bg-surface-container-lowest p-4 rounded-xl card-shadow border border-surface-variant text-center">
                                ...
                                <h3 class="font-headline-md mb-1" style="color: var(--on-surface);">
                                    <c:out value="${not empty profile.fullName ? profile.fullName : 'Guest Lecturer'}" />
                                </h3>
                                <p class="font-body-sm text-on-surface-variant mb-4">
                                    <c:out value="${not empty lecturer.department ? lecturer.department : 'Department not set'}" />
                                </p>
                            ...
                            <div class="bg-surface-container-lowest p-4 rounded-xl card-shadow border border-surface-variant">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <h4 class="font-title-lg mb-0" style="color: var(--on-surface);">Library Status</h4>
                        ...
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div class="bg-surface-container-lowest p-4 rounded-xl card-shadow border border-surface-variant">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="d-flex flex-column gap-1 border-bottom border-surface-variant pb-2">
                                            <label class="font-label-md text-on-surface-variant text-uppercase tracking-wider">Lecturer Code</label>
                                            <p class="font-body-md mb-0 text-on-surface fw-bold">
                                                <c:out value="${not empty lecturer.lecturerCode ? lecturer.lecturerCode : 'Not set'}" />
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                            ...
                            <div class="bg-surface-container-lowest p-4 rounded-xl card-shadow border border-surface-variant">
                                <div class="d-flex align-items-center gap-2 mb-4">
                                    ...
                                    <h4 class="font-title-lg mb-0" style="color: var(--on-surface);">Faculty Membership</h4>
                                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-4">
                                    <div class="p-3 rounded-xl text-white h-100" style="background-color: var(--bs-primary);">
                                        ...
                                        <p class="font-label-md mb-0 text-white-50">Publications Read</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4">
                                    <div class="bg-surface-container-high p-3 rounded-xl h-100">
                                        ...
                                        <p class="font-label-md mb-0 text-on-surface-variant">Recommended Papers</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4">
                                    <div class="bg-secondary-container p-3 rounded-xl h-100">
                                        ...
                                        <p class="font-label-md mb-0 text-on-secondary-container text-opacity-75">10% Faculty Readers</p>
                                    </div>
                                </div>
                            </div>
