            ...
            <div class="container-fluid px-4 py-4" style="max-width: 1400px; margin: 0 auto;">
                ...
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb" style="font-size: 14px;">
                        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/lecturer/dashboard" class="text-decoration-none" style="color: var(--primary);">Trang chủ</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tiền phạt & Thanh toán</li>
                    </ol>
                </nav>
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4">
                    <div>
                        <h1 class="fw-bold mb-1" style="color: var(--on-surface); font-size: 22px;">Tiền phạt & Thanh toán</h1>
                        <p class="mb-0" style="color: var(--on-surface-variant); font-size: 14px;">Theo dõi các khoản phạt phát sinh và thanh toán trực tuyến qua mã QR ngân hàng.</p>
                    </div>
                </div>
...
function copyToClipboard(text) {
    navigator.clipboard.writeText(text).then(function() { showCopyToast('Đã sao chép!'); });
}

function copyTransferContent() {
    var content = document.getElementById('modalTransferContent').textContent;
    navigator.clipboard.writeText(content).then(function() { showCopyToast('Đã sao chép nội dung chuyển khoản!'); });
}
