        ...
        <div class="container-xl px-4 py-5">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb" style="font-size: 14px;">
                    <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/lecturer/dashboard" class="text-decoration-none" style="color: var(--primary-color);">Bảng điều khiển</a></li>
                                                ...
                                                <c:forEach var="br" items="${borrows}">
                                                    <tr>
                                                        ...
                                                        <td class="py-3 text-end px-4">
                                                            <form action="${pageContext.request.contextPath}/lecturer/renew" method="post" class="d-inline">
                                            ...
                                            <tbody>
                                                <c:forEach var="res" items="${reservations}">
                                                    <tr>
                                                        ...
                                                        <td class="py-3 text-end px-4">
                                                            <form action="${pageContext.request.contextPath}/lecturer/cancel-reservation" method="post" class="d-inline" onsubmit="return confirm('Bạn có chắc chắn muốn hủy đặt trước cuốn sách này?');">
