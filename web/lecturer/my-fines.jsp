        ...
        <main class="flex-grow-1 overflow-y-auto" style="background-color: #f7f9fb;">
            <div class="container-xl px-4 py-5">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
                    <div>
                        <h2 class="font-headline-lg mb-1" style="color: var(--primary); font-weight: 600;">Giảng viên: Tiền phạt & Thanh toán</h2>
                        <p class="font-body-md text-on-surface-variant mb-0">Theo dõi và thanh toán các khoản phạt của thư viện cấp khoa hoặc trường.</p>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12 col-md-4">
                        <div class="raised-card p-4 border border-outline-variant d-flex align-items-center gap-3">
                            ...
                            <div>
                                <span class="font-label-md text-on-surface-variant text-uppercase">Số dư chưa thanh toán</span>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="raised-card p-4 border border-outline-variant d-flex align-items-center gap-3">
                            ...
                            <div>
                                <span class="font-label-md text-on-surface-variant text-uppercase">Tổng số đã thanh toán</span>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="raised-card p-4 border border-outline-variant d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold text-primary-custom mt-1">2 Biên lai</h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-pills mb-4 gap-2" id="fineTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active rounded-pill fw-bold" id="unpaid-tab" data-bs-toggle="pill" data-bs-target="#unpaid-content" type="button" role="tab" aria-controls="unpaid-content" aria-selected="true">
                                Tiền phạt chưa thanh toán hoạt động (2)
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            ...
                            <form action="${pageContext.request.contextPath}/lecturer/payment-checkout.jsp" method="POST" id="checkoutForm">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small class="text-muted">Mã vạch: LMS-BK-22891 • Trang bị hỏng (Đổ chất lỏng)</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>Apr 14, 2026</td>
                                                <td><span class="badge badge-overdue">60 Ngày</span></td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small class="text-muted">Mã vạch: LMS-BK-49210 • Phạt trả quá hạn</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>May 29, 2026</td>
                                                <td><span class="badge badge-due-soon">6 Ngày</span></td>
                                ...
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mt-4 pt-3 border-top gap-3">
                                    <div>
                                        ...
                                        <h4 class="mb-0 mt-1">Tổng số tiền phải trả: <span id="totalAmountDisplay" class="fw-bold text-primary-custom">$0.00</span></h4>
                                    </div>
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Trả muộn - Động lực học chất lỏng nâng cao</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Mất sách - Sổ tay vật lý laser</td>
