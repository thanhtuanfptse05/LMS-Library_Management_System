...
<body class="d-flex flex-column">
        ...
        <main class="flex-grow-1 overflow-y-auto" style="background-color: #faf9f8;">
            <div class="container-xl px-4 py-5" style="max-width: 1400px; margin: 0 auto;">
                ...
                <div class="row g-4">
                    ...
                    <!-- Right Area: Stats & Info (Narrow, 4 Columns) -->
                    <div class="col-12 col-lg-4">
                            ...
                            <div class="d-flex flex-column gap-3">
                                <div class="d-flex justify-content-between align-items-center p-3 rounded-3 bg-light">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="material-symbols-outlined" style="color: var(--tertiary, #006398);">drafts</span>
                        ...
                        <div class="raised-card shadow-sm p-4" style="background-color: rgba(0, 99, 152, 0.05); border: 1px solid rgba(0, 99, 152, 0.15);">
                            <div class="d-flex align-items-start gap-3">
                                <span class="material-symbols-outlined fs-4" style="color: var(--tertiary, #006398);">info</span>
                                <div>
    ...
    <!-- ════════════════ SCRIPTS ════════════════ -->
    <script>
        // Xem chi tiết bản tin trong modal
