    ...
    <div class="d-flex main-wrapper overflow-hidden">
        ...
        <main class="flex-grow-1 overflow-y-auto" style="background-color: #f7f9fb;">
            <div class="container-xl px-4 py-5">
                ...
                <!-- Page Title -->
                <div class="mb-4">
                    <h2 class="font-headline-lg mb-1" style="color: var(--primary); font-weight: 600;">Giảng viên: Thanh toán</h2>
                    <p class="font-body-md text-on-surface-variant">Xem lại chi tiết hóa đơn của bạn và chọn phương thức thanh toán.</p>
                </div>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-12 col-md-6">
                                    <div class="d-flex justify-content-between py-2 border-bottom">
                                        <span class="text-muted">Tổng phụ tiền phạt</span>
                            ...
                            <div class="d-flex flex-column gap-3 mb-4 flex-grow-1">
                                ...
                                <label class="border rounded-3 p-3 d-flex align-items-center justify-content-between cursor-pointer" style="border-color: var(--outline-variant) !important; background-color: var(--surface-container-low);">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <p class="mb-0 fw-bold">Cổng thanh toán VNPAY</p>
                                            <small class="text-muted">Mã QR, E-Banking, Thẻ tín dụng</small>
                                        </div>
                                    </div>
