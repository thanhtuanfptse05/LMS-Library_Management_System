...
<body class="d-flex flex-column">
            ...
            <div class="container-xl px-4 py-5" style="max-width: 1200px; margin: 0 auto;">
                ...
                <nav class="mb-2 d-flex align-items-center gap-1 text-muted small fw-semibold text-uppercase"
                    ...
                    <a class="text-decoration-none text-muted link-dark"
                       href="${pageContext.request.contextPath}/student/dashboard">Trang chß╗º</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="raised-card p-4"
                             style="background: linear-gradient(135deg, rgba(249,115,22,0.04), rgba(157,67,0,0.02)); border: 1px solid rgba(157,67,0,0.12);">
                            <div class="d-flex align-items-start gap-3">
                                <div class="rounded-2 d-flex align-items-center justify-content-center flex-shrink-0"
                                     style="width: 36px; height: 36px; background: rgba(157,67,0,0.1);">
                                    <span class="material-symbols-outlined" style="color: var(--primary); font-size: 20px; font-variation-settings: 'FILL' 1;">info</span>
                                </div>
                                <div>
    ...
    <script>
        ...
        function updateBadgeCount(newCount) {
            ...
            // Update the header badge (if header has one)
            const badgeEl = document.getElementById('headerUnreadBadge');
            if (badgeEl) {
                if (currentUnreadCount > 0) {
                    badgeEl.textContent = currentUnreadCount;
        ...
        async function markOneRead(notifId) {
            ...
            } catch (e) { /* Silent fail ΓÇö kh├┤ng block UX */ }
        }
            ...
            markAllBtn.addEventListener('click', async () => {
                ...
                try {
                    ...
                    if (data.status === 'ok') {
                        ...
                        updateBadgeCount(0);
                        // Hide mark-all button area
                        markAllBtn.closest('.d-flex')?.remove();
                    }
                } catch (e) {
        ...
        function openNotifDetail(btn) {
            ...
            const typeRaw   = card.classList.contains('notif-card--pinned') ? '' : '';
            // Extract type from badge class: look for type-X class on badge span
            ...
            // Mark as read (auto-trigger when opening detail)
