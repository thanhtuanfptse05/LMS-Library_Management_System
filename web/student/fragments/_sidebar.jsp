...
<aside class="offcanvas-lg offcanvas-start lms-sidebar sidebar-layout" tabindex="-1" id="studentSidebarOffcanvas" aria-labelledby="studentSidebarOffcanvasLabel">
    ...
    <div class="offcanvas-header sidebar-brand border-bottom d-lg-none py-2 px-3">
        ...
        <button type="button" class="btn-close text-reset ms-auto" data-bs-dismiss="offcanvas" data-bs-target="#studentSidebarOffcanvas" aria-label="Đóng"></button>
    </div>
