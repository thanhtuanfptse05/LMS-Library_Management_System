                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="ps-3">
                                                    <input type="checkbox" name="selectedFines" value="FINE-9801" data-amount="12.00" class="form-check-input fine-checkbox" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="ps-3">
                                                    <input type="checkbox" name="selectedFines" value="FINE-9824" data-amount="12.00" class="form-check-input fine-checkbox" />
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="d-flex align-items-center justify-content-center rounded bg-light" style="width: 40px; height: 50px;">
                        ...
                        <div class="tab-pane fade" id="history-content" role="tabpanel" aria-labelledby="history-tab">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="ps-3 fw-bold">REC-2026-4402</td>
                                            <td>May 10, 2026</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="ps-3 fw-bold">REC-2026-1205</td>
                                            <td>Apr 14, 2026</td>
                                            <td>
                                                <span class="d-flex align-items-center gap-1">
