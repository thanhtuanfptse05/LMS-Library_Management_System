...
<head>
    ...
    <meta name="description" content="Circulation and catalog management panel for LMS University Library librarians." />
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .header-search-input {
            width: 320px; padding-left: 40px;
            background-color: var(--surface-container-low);
            border: none; border-radius: 0.75rem; height: 40px;
            transition: box-shadow 0.2s ease; font-size: 14px;
        }
