                        ...
                        <form id="formCheckIn"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-outline-success d-flex align-items-center gap-1 btn-scan" onclick="toggleScanner('barcode', this)" style="border-color:var(--outline-variant);">
