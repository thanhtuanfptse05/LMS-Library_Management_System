...
<style>
    /* ── Page-scoped styles for Copy Edit (focus-mode form) ── */
...
<body class="d-flex flex-column">
            ...
            <div class="container-fluid px-4 py-4" style="max-width: 1400px; margin: 0 auto;">
                ...
                <div class="form-content-max">
                    ...
                    <div class="book-banner">
                        ...
                        <div class="flex-grow-1 min-width-0">
                            ...
                            <p class="mb-0" style="font-size: 13px; color: var(--on-surface-variant);">
                                <c:out value="${not empty copy.book.author ? copy.book.author : 'Eleanor Vance'}" />
                                <c:if test="${not empty copy.book.publishYear}">
                                    &middot; <c:out value="${copy.book.publishYear}" />
                                </c:if>
                            </p>
                        </div>
                    ...
                    <form action="${pageContext.request.contextPath}/librarian/copies" method="POST"
                          id="editCopyForm" novalidate>
                        <input type="hidden" name="action" value="editCopy" />
                        <input type="hidden" name="copyId" value="<c:out value='${copy.copyId}'/>" />
                        <%-- Return to book detail after save --%>
                        <input type="hidden" name="bookId" value="<c:out value='${copy.bookId}'/>" />
    ...
    <script>
        (() => {
            ...
            document.getElementById('editCopyForm').addEventListener('submit', function (e) {
