...
<%-- Trang: book-categories.jsp - Quản lý Thể loại Sách (Category) --%>
<%-- Cho phép Thủ thư tạo mới, ẩn/hiện và cập nhật mô tả --%>
<%-- đối với các danh mục phân loại chính của thư viện --%>
                ...
                <form method="post" action="${pageContext.request.contextPath}/book-management/categories">
                    ...
                    <div class="modal-header">
                        <div>
                            ...
                            <p class="bm-section-note mb-0">Thể loại mới sẽ sẵn sàng để gán cho đầu sách.</p>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Tên thể loại <span class="bm-required">*</span></label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary-custom" type="submit">Lưu thể loại</button>
                    </div>
                </form>
            </div>
        </div>
...
<%-- Modal 2: Chỉnh sửa thể loại (cho phép cập nhật mô tả và ẩn/hiện thể loại) --%>
                ...
                <form method="post" action="${pageContext.request.contextPath}/book-management/categories">
                    ...
                    <div class="modal-header">
                        <div>
                            ...
                            <p class="bm-section-note mb-0">Ẩn thể loại để ngừng gán mới mà vẫn giữ lịch sử.</p>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="name" required maxlength="255" value="<c:out value="${editCategory.name}" />">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Mô tả</label>
                            <textarea class="form-control" name="description" rows="4"><c:out value="${editCategory.description}" /></textarea>
                        </div>
                        <div>
                            <label class="form-label">Trạng thái</label>
                            <select class="form-select" name="status">
                                <option value="active" ${editCategory.status == 'active' ? 'selected' : ''}>Đang dùng</option>
                                <option value="hidden" ${editCategory.status == 'hidden' ? 'selected' : ''}>Đã ẩn</option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer">
