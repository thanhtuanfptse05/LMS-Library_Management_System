...
<header class="fixed-top bg-white shadow-sm" style="height: 64px; border-bottom: 1px solid var(--outline-variant);">
    <div class="h-100 d-flex align-items-center justify-content-between px-4 header-layout">
        ...
        <div class="d-flex align-items-center gap-4">
            <h1 class="h5 fw-bold mb-0 text-primary-custom">Hệ thống Bảng điều khiển Quản trị viên</h1>
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <a href="${pageContext.request.contextPath}/admin/profile" class="d-flex align-items-center gap-2 ps-3 text-decoration-none text-reset" style="border-left: 1px solid var(--outline-variant);" title="Xem Hồ sơ">
