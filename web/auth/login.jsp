        ...
        <section class="auth-split-right">
            <div style="width: 100%; max-width: 450px;">
                ...
                <div style="margin-top: var(--space-md);">
                    <a href="${pageContext.request.contextPath}/login-google" style="display: flex; align-items: center; justify-content: center; gap: 12px; width: 100%; height: 44px; background-color: #ffffff; color: #3c4043; text-decoration: none; border-radius: 4px; border: 1px solid #dadce0; font-family: 'Inter', sans-serif; font-size: 14px; font-weight: 500; transition: background-color 0.2s ease, box-shadow 0.2s ease;" onmouseover="this.style.backgroundColor='#f8f9fa'; this.style.boxShadow='0 1px 2px 0 rgba(60,64,67,0.3), 0 1px 3px 1px rgba(60,64,67,0.15)';" onmouseout="this.style.backgroundColor='#ffffff'; this.style.boxShadow='none';" id="google-login-btn">
