                    ...
                    <div class="col-lg-6 d-none d-lg-block hero-side">
                        ...
                        <div class="hero-content d-flex flex-column justify-content-between">
                            ...
                            <div style="max-width: 450px;">
                                ...
                                <p class="fs-5 text-white-50">Quản lý mượn trả, duyệt bộ sưu tập, và kết nối với các tài
                                    nguyên nghiên cứu toàn cầu thông qua hệ sinh thái Thư viện Lumina.</p>
                            </div>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <p class="small text-white mb-0 ms-3">Tham gia cùng hàng ngàn nhà nghiên cứu tích cực
                                    ngay hôm nay.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-container-wrapper py-5">
                            ...
                            <div class="mb-4">
                                <a href="${pageContext.request.contextPath}/"
                                    class="btn-outline-custom gap-2 text-decoration-none">
                            ...
                            <div class="text-start mb-4">
                                ...
                                <p class="text-muted">Vui lòng nhập thông tin đăng nhập thư viện để truy cập bảng điều
                                    khiển của bạn.</p>
                            </div>
                            ...
                            <c:if test="${param.resetSuccess == 'true'}">
                                <div class="alert alert-success d-flex align-items-center gap-2 mb-4" role="alert"
                                    ...
                                    <div>Nếu email hợp lệ, mật khẩu mới đã được gửi. Vui lòng kiểm tra hộp thư của bạn.
                                    </div>
                                </div>
                            </c:if>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-custom">
                                        ...
                                        <input class="form-control" id="email" name="email"
                                            placeholder="librarian@lumina.edu" required type="text">
                                    </div>
                                </div>

                                <div class="mb-4">
                                    <div class="d-flex justify-content-between align-items-center px-1 mb-1">
                                        <label class="form-label small fw-bold text-muted mb-0" for="password">Mật
                                            khẩu</label>
                                        <a class="small fw-bold text-decoration-none"
                            ...
                            <a href="${pageContext.request.contextPath}/login-google"
                                class="btn-google w-100 d-flex align-items-center justify-content-center gap-3 mb-5 text-decoration-none">
                                <svg class="bi" width="20" height="20" viewBox="0 0 24 24"
                            ...
                            <footer
                                ...
                                <p class="small text-muted mb-0 opacity-75">© 2026 Thư viện Đại học LMS System</p>
                            </footer>
