        ...
        <header class="dash-header">
            <div class="header-search">
                <div class="search-box">
                    ...
                    <input class="dash-input with-icon" placeholder="Global search..." type="text"/>
                </div>
            </div>
            <div class="header-actions">
                <div class="action-icons">
                    <button class="material-symbols-outlined hover-primary icon-md" class="icon-btn">notifications</button>
                    <button class="material-symbols-outlined hover-primary icon-md" class="icon-btn">help</button>
                </div>
                <div class="header-divider" style="width: 1px;"></div>
                <div class="user-profile">
                    <div class="user-info">
                        <span class="user-name">Alex Rivera</span>
                        <span class="user-role">Librarian Manager</span>
                    </div>
                    <img alt="Manager Avatar" class="user-avatar" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBN3f9A2lHooYxfgTRxOgSvElYjOLLD7frT3HX4jdMKb35RY4aCnY91vR9ZQTz5leT1slGYaUdZVLjwr_dKlK9Jwl0IqJXG3YrZt6yfzSbVyZp5Phtg2r3InhTNboCa7hkpA-ssPCzC9p0OmG4bt55uA9fb5vxL8SPhxuk8kOq6IpE1S3XN_nwfij2VGk0lTeTqheWJEI9Tk5lERWSh9bKTnWRv9Iu1btBNE2Hv7L9DSDDfKKLKl9s0xwJWFp6Mm9oBk7_JoIFIKcPW"/>
                </div>
                <!-- Logout Button -->
            ...
            <div class="dash-container">
                <div class="page-header">
                    <div>
                        ...
                        <p class="page-subtitle">Overview of system health, inventory, and finances.</p>
                    </div>
                ...
                <div class="stats-grid">
                    ...
                    <div class="metric-card border-primary">
                        <div class="metric-header">
                            ...
                            <span class="metric-trend trend-up">+2.4% <span class="material-symbols-outlined" style="font-size: 14px;">trending_up</span></span>
                        </div>
                    ...
                    <div class="metric-card border-tertiary">
                        <div class="metric-header">
                            ...
                            <span class="metric-trend trend-up">+1.2% <span class="material-symbols-outlined" style="font-size: 14px;">trending_up</span></span>
                        </div>
                        <p class="metric-label">Active Members</p>
                        <h3 class="metric-value">12,400</h3>
                    </div>
                    <!-- Revenue -->
                    <div class="metric-card border-success">
                        <div class="metric-header">
                            ...
                            <span class="metric-trend trend-up">+18% <span class="material-symbols-outlined" style="font-size: 14px;">trending_up</span></span>
                        </div>
                        <p class="metric-label">Fine Revenue (Month)</p>
                    ...
                    <div class="metric-card border-error">
                        <div class="metric-header">
                            ...
                            <span class="metric-trend trend-down">Alert <span class="material-symbols-outlined" style="font-size: 14px;">warning</span></span>
                        </div>
                        <p class="metric-label">Missing/Damaged</p>
                ...
                <div class="bento-grid">
                    ...
                    <div class="dash-card bento-main">
                        <div class="card-header">
                            <h4 class="card-title">Most Borrowed Books</h4>
                        ...
                        <div class="item-list">
                            ...
                            <div class="list-item">
                                ...
                                <div class="item-details">
                                    <p class="item-title">Principles of Modern Physics</p>
                                    <p class="item-subtitle">By Dr. Julian Thorne</p>
                                    <div class="progress-bar-bg">
                                        <div class="progress-bar-fill" style="width: 85%;"></div>
                                    </div>
                                </div>
                                <span class="item-stat">248 <span class="text-label-sm font-medium text-on-surface-variant">loans</span></span>
                            </div>
                            <!-- Book Item 2 -->
                            <div class="list-item">
                                <div class="item-image">
                                ...
                                <div class="item-details">
                                    <p class="item-title">The Art of Architecture</p>
                                    <p class="item-subtitle">By Sarah L. May</p>
                                    <div class="progress-bar-bg">
                                        <div class="progress-bar-fill" style="width: 72%;"></div>
                                    </div>
                                </div>
                                <span class="item-stat">210 <span class="text-label-sm font-medium text-on-surface-variant">loans</span></span>
                            </div>
                            <!-- Book Item 3 -->
                            <div class="list-item">
                                <div class="item-image">
                                ...
                                <div class="item-details">
                                    <p class="item-title">Organic Chemistry III</p>
                                    <p class="item-subtitle">By Prof. Michael Chen</p>
                                    <div class="progress-bar-bg">
                                        <div class="progress-bar-fill" style="width: 65%;"></div>
                                    </div>
                                </div>
                                <span class="item-stat">189 <span class="text-label-sm font-medium text-on-surface-variant">loans</span></span>
                            </div>
                            <!-- Book Item 4 -->
                            <div class="list-item">
                                <div class="item-image">
                                ...
                                <div class="item-details">
                                    <p class="item-title">Economic Foundations</p>
                                    <p class="item-subtitle">By Dr. Elena Vance</p>
                                    <div class="progress-bar-bg">
                                        <div class="progress-bar-fill" style="width: 58%;"></div>
                                    </div>
                                </div>
                                <span class="item-stat">172 <span class="text-label-sm font-medium text-on-surface-variant">loans</span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bento-side">
                        <div class="dash-card">
                            ...
                            <ul class="alert-list">
                                <li class="alert-item error">
                                    <div>
                                        <p class="alert-title">Data Structures 101</p>
                                        <span class="alert-status error">1 copy left</span>
                                    </div>
                                ...
                                <li class="alert-item error">
                                    <div>
                                        <p class="alert-title">Modern Sociology</p>
                                        <span class="alert-status error">Out of Stock</span>
                                    </div>
                                    <button class="btn btn-ghost" style="padding: 8px;">
                                        <span class="material-symbols-outlined">add_shopping_cart</span>
                                    </button>
                                ...
                                <li class="alert-item warning">
                                    <div>
                                        <p class="alert-title">Linear Algebra II</p>
                                        <span class="alert-status warning">2 copies left</span>
                                    </div>
                                    <button class="btn btn-ghost" style="padding: 8px;">
                                        <span class="material-symbols-outlined">add_shopping_cart</span>
                                    </button>
                        ...
                        <div class="insights-card">
                            <h4 class="insights-title">Quick Insights</h4>
                            <div class="insights-list">
                                <div class="insight-item">
                                    <span class="material-symbols-outlined text-primary">schedule</span>
                                    <div>
                                        <p class="insight-label">Peak Hours</p>
                                ...
                                <div class="insight-item">
                                    ...
                                    <div>
                                        <p class="insight-label">Top Department</p>
                    ...
                    <div class="dash-card table-card bento-main">
                        <div class="table-header">
                            <h4 class="card-title">Recent Fine Payments</h4>
                        ...
                        <div class="table-container custom-scrollbar">
                            <table class="dash-table">
                                <thead class="bg-surface-container-low">
                                    <tr>
                                        <th class="px-6 py-3 text-label-md text-on-surface-variant" >Member Name</th>
                                        <th class="px-6 py-3 text-label-md text-on-surface-variant" >Payment Method</th>
                                        <th class="px-6 py-3 text-label-md text-on-surface-variant" >Amount</th>
                                        <th class="px-6 py-3 text-label-md text-on-surface-variant" >Date</th>
                                        <th class="px-6 py-3 text-label-md text-on-surface-variant" class="text-right">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <button class="material-symbols-outlined text-outline hover-primary" class="icon-btn">more_vert</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="px-6 py-4">
