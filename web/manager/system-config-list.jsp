        ...
        <div class="d-flex main-wrapper overflow-hidden">
            <main class="flex-grow-1 overflow-y-auto main-content-layout" style="background-color: #f7f9fb;">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-3 mb-4">
                    <div>
                        <h2 class="fw-bold mb-0 text-primary-custom" style="font-size: 22px;">Cấu hình Hệ thống Thư viện</h2>
                                                ...
                                                <c:forEach var="cfg" items="${configs}">
                                                    <tr>
                                                        <td class="ps-4">
                                                            ...
                                                            <div class="text-on-surface-variant text-truncate" style="font-size: 11px; max-width: 250px;" title="<c:out value="${cfg.description}"/>">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <form action="${pageContext.request.contextPath}/manager/system-config" method="POST" class="modal-content">
                            <div class="modal-header border-0 pb-0">
                                <h5 class="modal-title fw-bold text-primary-custom" id="editModalLabel" style="font-size: 18px;">Cập nhật cấu hình</h5>
