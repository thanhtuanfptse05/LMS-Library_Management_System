                                ...
                                <c:forEach var="cfg" items="${configs}">
                                    <tr>
                                        ...
                                        <td class="text-end" style="white-space: nowrap;">
                                            ...
                                            <form action="${pageContext.request.contextPath}/manager/system-config" method="POST" class="d-inline-block m-0" onsubmit="return confirm('Bạn có chắc chắn muốn xóa cấu hình này không?');">
