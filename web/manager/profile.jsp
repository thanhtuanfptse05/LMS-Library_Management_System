    ...
    <div class="d-flex main-wrapper overflow-hidden">
        ...
        <main class="flex-grow-1 overflow-y-auto" style="background-color: #f7f9fb; margin-left: 256px;">
            ...
            <div class="container-fluid px-4 py-4" style="max-width: 1400px; margin: 0 auto;">
                ...
                <div class="mb-4">
                    <h2 class="font-headline-lg mb-1" style="color: var(--on-surface);">Manager Profile</h2>
                    <p class="font-body-md text-on-surface-variant">Manage your library manager credentials and contact details.</p>
                </div>
                        ...
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div class="bg-surface-container-lowest p-4 rounded-xl card-shadow border border-surface-variant text-center">
                                ...
                                <h3 class="font-headline-md mb-1" style="color: var(--on-surface);">
                                    <c:out value="${not empty profile.fullName ? profile.fullName : 'Library Manager'}" />
                                </h3>
                                <p class="font-body-sm text-on-surface-variant mb-4">
                                    Library Manager <br/>
                                    Staff ID: <span class="fw-bold"><c:out value="${manager.staffCode}" /></span>
                                </p>
                            ...
                            <div class="bg-surface-container-lowest p-4 rounded-xl card-shadow border border-surface-variant">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <h4 class="font-title-lg mb-0" style="color: var(--on-surface);">Library Health</h4>
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="font-body-sm text-on-surface-variant">Total Members</span>
                                        <span class="font-label-md fw-bold" style="color: #059669;">12,890</span>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="font-body-sm text-on-surface-variant">Active Fines</span>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="d-flex flex-column gap-1 border-bottom border-surface-variant pb-2">
                                            ...
                                            <p class="font-body-md mb-0 text-on-surface fw-bold">
                                                <c:out value="${not empty manager.staffCode ? manager.staffCode : 'Not set'}" />
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-4">
                                    <div class="p-3 rounded-xl text-white h-100" style="background-color: var(--bs-primary);">
                                        ...
                                        <p class="font-label-md mb-0 text-white-50">Total Books Managed</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4">
                                    <div class="bg-surface-container-high p-3 rounded-xl h-100">
                                        ...
                                        <p class="font-label-md mb-0 text-on-surface-variant">Policies Updated</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4">
                                    <div class="bg-secondary-container p-3 rounded-xl h-100">
                                        ...
                                        <p class="font-label-md mb-0 text-on-secondary-container text-opacity-75">Templates Managed</p>
                                    </div>
                                </div>
                            </div>
