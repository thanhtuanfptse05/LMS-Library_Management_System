<%-- Fragment: _head.jsp — <head> block for Library Manager Dashboard --%>
<head>
    <meta charset="utf-8" />
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <title>Library Manager Dashboard - LMS University Library</title>
    <meta name="description" content="Strategic management and reporting panel for Library Managers at LMS University." />
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .bar-track {
            ...
            background-color: var(--primary); transition: height 0.8s ease;
        }
        ...
        .policy-item:hover { border-color: var(--primary); }

        /* ─── Announcement ─── */
        .announcement-card {
            padding: 16px; border-radius: 12px;
            border-left: 4px solid var(--primary);
            background-color: rgba(253, 219, 178, 0.25);
        }
