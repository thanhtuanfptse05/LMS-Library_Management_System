...
<header class="lms-header header-layout">
    ...
    <button class="btn btn-icon d-lg-none me-2 text-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#managerSidebarOffcanvas" aria-controls="managerSidebarOffcanvas" aria-label="Mở menu">
