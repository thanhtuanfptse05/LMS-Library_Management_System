...
<header class="lms-header header-layout" style="overflow: visible;">
    ...
    <div class="d-flex align-items-center gap-2 flex-shrink-0">
        ...
        <!-- ════ NOTIFICATION BELL ════ -->
        <div class="notif-bell-wrapper" id="mgrNotifWrapper">
            <button class="header-icon-btn notif-bell-btn"
                    id="mgrNotifBtn"
                    aria-label="Thông báo"
                    aria-expanded="false"
                    aria-controls="mgrNotifPanel">
            ...
            <!-- ════ DROPDOWN PANEL ════ -->
            <div class="notif-panel" id="mgrNotifPanel" role="dialog" aria-label="Bảng thông báo">
                ...
                <!-- Panel Body -->
                <div class="notif-panel-body" id="mgrNotifBody">
                    <c:choose>
...
<style>
    ...
    .notif-header-count {
        ...
        border-radius: 999px;
        padding: 2px 8px;
        border: 1px solid rgba(157,67,0,0.15);
    }
    .notif-see-all-btn {
        font-size: 12px;
        font-weight: 700;
    ...
    .notif-item:hover {
        background: linear-gradient(90deg, rgba(157,67,0,0.03), transparent);
    }
    .notif-item-pinned {
        background: linear-gradient(90deg, rgba(157,67,0,0.04), transparent) !important;
    }
    .notif-item-pinned:hover {
        background: linear-gradient(90deg, rgba(157,67,0,0.08), transparent) !important;
    }
...
(function() {
    ...
    var wrapper = document.getElementById('mgrNotifWrapper');
