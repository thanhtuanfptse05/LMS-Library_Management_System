...
<aside class="d-none d-lg-flex flex-column gap-4 p-4"
    ...
    <a href="${pageContext.request.contextPath}/" class="text-decoration-none d-block">
        ...
        <p class="text-on-surface-variant mb-0" style="font-size: 10px; letter-spacing: 0.1em; text-transform: uppercase;">Management Control</p>
    </a>

    <!-- Navigation -->
    <div class="flex-grow-1 d-flex flex-column gap-1">
        <p class="text-on-surface-variant fw-bold text-uppercase mb-1" style="font-size: 10px; letter-spacing: 0.15em;">Overview</p>
        ...
        <a class="sidebar-link" href="#">
            <span class="material-symbols-outlined">summarize</span><span>Reports</span>
        </a>
        <p class="text-on-surface-variant fw-bold text-uppercase mb-1 mt-3" style="font-size: 10px; letter-spacing: 0.15em;">Operations</p>
        <a class="sidebar-link" href="#">
            <span class="material-symbols-outlined">people</span><span>Staff Management</span>
        </a>
        <a class="sidebar-link" href="#">
    ...
    <div class="mt-auto p-3 rounded-3" style="background-color: var(--surface-container-high); border: 1px solid var(--outline-variant);">
        <p class="fw-bold mb-2 text-on-surface-variant" style="font-size: 11px;">Reporting Period</p>
        <select class="form-select form-select-sm rounded-3" style="border: 1px solid var(--outline-variant); color: var(--on-surface);" aria-label="Select reporting period">
