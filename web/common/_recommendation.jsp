                        ...
                        <div class="card-body p-3 d-flex flex-column flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap gap-1 mb-2">
                                <c:forEach var="cat" items="${book.categories}">
                                    <span class="badge fw-normal" style="font-size: 10px; background-color: rgba(249, 115, 22, 0.1); color: #f97316; border: 1px solid rgba(249, 115, 22, 0.2);">
                                        <c:out value="${cat.name}"/>
                                    </span>
                                </c:forEach>
                                <c:forEach var="tg" items="${book.tags}">
                                    <span class="badge fw-normal" style="font-size: 10px; background-color: rgba(59, 130, 246, 0.1); color: #3b82f6; border: 1px solid rgba(59, 130, 246, 0.2);">
                                        #<c:out value="${tg.name}"/>
                                    </span>
                                </c:forEach>
                            </div>
