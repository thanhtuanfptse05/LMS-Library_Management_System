<%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" language="java" %>
    ...
    <footer id="contact"
        style="background-color: var(--surface-lowest); border-top: 1px solid rgba(219, 194, 176, 0.5);">
        ...
        <div class="container-xl px-4 py-5">
            <div class="row g-5 align-items-start">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <p class="mb-3"
                        style="color: var(--text-muted-custom); font-size: 14px; line-height: 1.7; max-width: 280px;">
                        Cung cấp quyền truy cập thông tin đẳng cấp thế giới cho cộng đồng học thuật. Cổng kết nối tri
                        thức của bạn từ năm 1954.
                    </p>
                    <!-- Quick policy links -->
                    <div class="d-flex flex-wrap gap-3" style="font-size: 13px;">
                        <a class="text-decoration-none" style="color: var(--text-muted-custom);" href="#">Chính sách bảo
                            mật</a>
                        <a class="text-decoration-none" style="color: var(--text-muted-custom);" href="#">Điều khoản sử
                            dụng</a>
                        <a class="text-decoration-none" style="color: var(--text-muted-custom);" href="#">Câu hỏi thường
                            gặp</a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <h5 class="fw-bold mb-3" style="font-size: 15px; color: var(--bs-body-color);">Liên hệ với chúng tôi
                    </h5>
                    <ul class="list-unstyled mb-0 d-flex flex-column gap-3"
                        style="font-size: 14px; color: var(--text-muted-custom);">
                        ...
                        <li class="d-flex align-items-center gap-2">
                            ...
                            <a href="mailto:library@unilib.edu.vn" class="text-decoration-none"
                                style="color: var(--text-muted-custom);">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <h6 class="fw-bold mb-2"
                        style="font-size: 13px; color: var(--bs-body-color); text-transform: uppercase; letter-spacing: 0.06em;">
                        Liên kết nhanh</h6>
        ...
        <div style="background-color: var(--primary-color); padding: 14px 0;">
            <div
                class="container-xl px-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
