...
@WebServlet(name = "LibrarianProfileServlet", urlPatterns = {"/librarian/profile"})
public class LibrarianProfileServlet extends HttpServlet {
    ...
    public LibrarianProfileServlet() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Librarian librarian = librarianDAO.findByUserId(userId);

        request.setAttribute("user", user);
        request.setAttribute("profile", profile);
        request.setAttribute("librarian", librarian);

        request.getRequestDispatcher("/librarian/profile.jsp").forward(request, response);
    }
